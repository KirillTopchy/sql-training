...
import { 
    ...
    selectAllRows} from "../src/queries/select";
...
const insertKeyBenefits = (keyBenefits: KeyBenefit[]) => {
    return (
        `INSERT INTO ${KEY_BENEFITS} (id, title, description) VALUES` + 
...
describe("Insert Data", () => {
    ...
    it("should insert apps pricing plans data", async done => {
        ...
        const prices = (await db.selectMultipleRows(selectAllRows(PRICING_PLANS))) as PricingPlanPrice[];
